...
var app = new Vue({
    ...
    methods: {
      ...
      countPaperRate: function () {
        ...
        this.paperNoLoseRate = (parseFloat(this.paperWinRate) + parseFloat(this.paperDrawRate)).toFixed(1);
      },
      countScissorsRate: function () {
        ...
        this.scissorsNoLoseRate = (parseFloat(this.scissorsWinRate) + parseFloat(this.scissorsDrawRate)).toFixed(1);
      },
      countStoneRate: function () {
        this.stoneWinRate = (this.scissorsCount / this.allCount * 100).toFixed(1);
        this.stoneDrawRate = (this.stoneCount / this.allCount * 100).toFixed(1);
        this.stoneNoLoseRate = (parseFloat(this.stoneWinRate) + parseFloat(this.stoneDrawRate)).toFixed(1);
      },
